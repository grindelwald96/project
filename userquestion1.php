...
if (!$conn) {
  ...
  $uid=$_SESSION["id"];
  $sql = "INSERT INTO userquestions(category, question, questiontype, visibility, userid, questiondate)VALUES ('$category', '$question', '$type', 1, '$uid', SYSDATE())";
  if($type=="mcq" or $type=="che"){
